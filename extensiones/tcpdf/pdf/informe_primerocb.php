...
$bloque7 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			</td><td style="font-size: 8px; text-align: center; border: 1px solid #666; background-color:white; width:100px">
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="font-size: 8px; text-align: center; border: 1px solid #666; background-color:white; width:100px">
				...
				$respuestaInforme[aulico_artistica]
			...
			<td style="font-size: 8px; text-align: center; border: 1px solid #666; background-color:white; width:100px">
				...
				$respuestaInforme[comportamiento_artistica]
			...
			<td style="font-size: 8px; text-align: center; border: 1px solid #666; background-color:white; width:100px">
				...
				$respuestaInforme[evaluacion_artistica]
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="font-size: 8px; text-align: center; border: 1px solid #666; background-color:white; width:100px">
				...
				$respuestaInforme[aulico_fisico_quimica]
			...
			<td style="font-size: 8px; text-align: center; border: 1px solid #666; background-color:white; width:100px">
				...
				$respuestaInforme[comportamiento_fisico_quimica]
			...
			<td style="font-size: 8px; text-align: center; border: 1px solid #666; background-color:white; width:100px">
				...
				$respuestaInforme[evaluacion_fisico_quimica]
			...
			<td style="font-size: 8px; text-align: justify; border: 1px solid #666; background-color:white; width:280px">
				...
				$respuestaInforme[observa_fisico_quimica]
