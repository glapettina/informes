                    ...
                    echo '<tr>
                          ...
                          echo '<td>
                            ...
                            if ($_SESSION["perfil"] != "Preceptor") {
                               ...
                               <button class="btn btn-info btnEditarPreceptoria" tabla="primero" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarPreceptoria"><i class="fa fa-pencil"></i></button>';
