		...
		<ul class="nav navbar-nav">
			...
			<li class="dropdown user user-menu">
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
					...
					<span class="hidden-xs">Docente: <?php echo $_SESSION["nombre"]; ?> - Perfil: <?php echo $_SESSION["perfil"]; ?> - Ciclo: <?php echo $_SESSION["ciclo"]; ?> - Materia: <?php echo $_SESSION["materia"]; ?> - Período: <?php echo $_SESSION["periodo"]; ?></span>
