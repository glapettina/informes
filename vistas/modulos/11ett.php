  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">1º Primera Electromecánica TT</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">                                      
                ...
                <button class="btn btn-primary btnInformeTercero" modalidad="superiore" materia="'.$_SESSION['materia'].'" ciclo="superiore" curso="tercero" periodo="'.$_SESSION['periodo'].'" idCurso=15 tabla="tercero" informe="informe-curso-tercero">
