  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <?php
                  ...
                  3º Segunda Electromecánica - Turno Vespertino - Materia: '.$mate["materia"].'
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">3º Segunda E TV</li>
      </ol>
    </section>
              ...
              <?php
                  ...
                  if ($_SESSION["perfil"] != "Preceptor") {
                    ...
                    echo '<div class="box-header with-border">                                      
                      ...
                      <button class="btn btn-primary btnInformeQuinto" mat="'.$ma.'" curso="'.$mate['curso_id'].'" periodo="'.$_SESSION['periodo'].'" idCurso=22 tabla="quinto" modalidad="Electromecánica" informe="informe-curso-quinto">
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              echo'<button class="btn btn-primary btnImprimirInformeQuinto" periodo="'.$_SESSION['periodo'].'" informe="informe_quinto" modalidad="electromecanica" tabla="quinto" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeCb"><i class="fa fa-print"></i></button>';
                            }
