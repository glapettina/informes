              ...
              <?php
                  ...
                  if ($_SESSION["perfil"] != "Preceptor") {
                    ...
                    echo '<div class="box-header with-border">                                      
                      ...
                      <button class="btn btn-primary btnInformeQuinto" mat="'.$ma.'" curso="'.$mate['curso_id'].'" periodo="'.$_SESSION['periodo'].'" idCurso=21 tabla="quinto" modalidad="Electromecánica" informe="informe-curso-quinto">
