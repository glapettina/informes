  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <?php
                  ...
                  3º Primera Alimentación - Turno Vespertino - Materia: '.$mate["materia"].'
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">3º Primera A TV</li>
      </ol>
    </section>
                    ...
                    echo '<tr>
                          ...
                          if ($_SESSION["perfil"] != "Preceptor") {
                            ...
                            echo'<div class="btn-group">
                              ...
                              echo'<button class="btn btn-primary btnImprimirInformeQuinto" periodo="'.$_SESSION['periodo'].'" informe="informe_quinto" modalidad="alimentacion" tabla="quinto" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeCb"><i class="fa fa-print"></i></button>';
                            }
        ...
        <!-- ENTRADA PARA EL CONCEPTO --> 
              ...
              <?php
                    ...
                    if ($mat == 'Procesos Productivos') {
                      ...
                      $campo1 = 'aulico_pproductivos';
                      $campo2 = 'comportamiento_pproductivos';
                      $campo3 = 'evaluacion_pproductivos';
                      $campo4 = 'observa_pproductivos';
                    } 
