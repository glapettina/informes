  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
              <?php
                    ...
                    2º Primera - Turno Tarde - Materia: '.$mate["materia"].'
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">2º Primera TT</li>
      </ol>
    </section>
                ...
                <?php
                  ...
                  if ($_SESSION["perfil"] != "Preceptor") {
                    ...
                    echo '<div class="box-header with-border">                                      
                      ...
                      <button class="btn btn-primary btnInformeSegundo" mat="'.$ma.'" curso="'.$mate['curso_id'].'" periodo="'.$_SESSION['periodo'].'" idCurso=10 tabla="segundo" informe="informe-curso-segundo">
