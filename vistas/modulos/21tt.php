        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">                                      
                ...
                <button class="btn btn-primary btnInformeSegundo" materia="'.$_SESSION['materia'].'" ciclo="basico" curso="segundo" periodo="'.$_SESSION['periodo'].'" idCurso=10 tabla="segundo" informe="informe-curso-segundo">
