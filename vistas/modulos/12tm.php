  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
              ...
              <?php
                    ...
                    1º Segunda - Turno Mañana - Materia: '.$mate["materia"].'
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">1º Segunda TM</li>
      </ol>
    </section>
                  ...
                  <?php
                    ...
                    if ($_SESSION["perfil"] != "Preceptor") {
                        ...
                        echo '<div class="box-header with-border">                                      
                          ...
                          <button class="btn btn-primary btnInformePrimero" mat="'.$ma.'" curso="'.$mate['curso_id'].'" periodo="'.$_SESSION['periodo'].'" idCurso=2 tabla="primero" informe="informe-curso-primero">
