        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">                                      
                ...
                <button class="btn btn-primary btnInformePrimero" materia="'.$_SESSION['materia'].'" ciclo="basico" curso="primero" periodo="'.$_SESSION['periodo'].'" idCurso=2 tabla="primero" informe="informe-curso-primero">
