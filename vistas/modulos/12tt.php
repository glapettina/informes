  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">1º Segunda TT</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">                                      
                ...
                <button class="btn btn-primary btnInformePrimero" materia="'.$_SESSION['materia'].'" ciclo="basico" curso="primero" periodo="'.$_SESSION['periodo'].'" idCurso=5 tabla="primero" informe="informe-curso-primero">
