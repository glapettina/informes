  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <?php
                  ...
                  1º Segunda Alimentación - Turno Tarde - Materia: '.$mate["materia"].'
                  ...
                  echo '<h1>
                  1º Segunda Alimentación - Turno Tarde
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">1º Segunda A TT</li>
      </ol>
    </section>
              ...
              <?php
                    ...
                    if ($_SESSION["perfil"] != "Preceptor") {
                      ...
                      echo '<div class="box-header with-border">                                      
                        ...
                        <button class="btn btn-primary btnInformePrimero" mat="'.$ma.'" curso="'.$mate['curso_id'].'" periodo="'.$_SESSION['periodo'].'" idCurso=13 tabla="tercero" informe="informe-curso-tercero">
