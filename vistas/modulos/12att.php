  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">1º Segunda Alimentación TT</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">                                      
                ...
                <button class="btn btn-primary btnInformeTercero" modalidad="superiora" materia="'.$_SESSION['materia'].'" ciclo="superiora" curso="tercero" periodo="'.$_SESSION['periodo'].'" idCurso=13 tabla="tercero" informe="informe-curso-tercero">
