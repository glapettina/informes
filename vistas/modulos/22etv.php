  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">2º Segunda Electromecánica TV</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">                                      
                ...
                <button class="btn btn-primary btnInformeCuarto" modalidad="superiore" materia="'.$_SESSION['materia'].'" ciclo="superiore" curso="cuarto" periodo="'.$_SESSION['periodo'].'" idCurso=18 tabla="cuarto" informe="informe-curso-cuarto">
