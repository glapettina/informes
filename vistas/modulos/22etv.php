  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <?php
                  ...
                  2º Segunda Electromecánica - Turno Vespertino - Materia: '.$mate["materia"].'
                  ...
                  echo '<h1>
                  2º Segunda Electromecánica - Turno Vespertino
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">2º Segunda E TV</li>
      </ol>
    </section>
              ...
              <?php
                  ...
                  if ($_SESSION["perfil"] != "Preceptor") {
                    ...
                    echo '<div class="box-header with-border">                                      
                      ...
                      <button class="btn btn-primary btnInformeCuarto" mat="'.$ma.'" curso="'.$mate['curso_id'].'" periodo="'.$_SESSION['periodo'].'" idCurso=18 tabla="cuarto" modalidad="Electromecánica" informe="informe-curso-cuarto">
