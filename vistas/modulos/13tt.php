  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <?php
                  ...
                  1º Tercera - Turno Tarde - Materia: '.$mate["materia"].'
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">1º Tercera TT</li>
      </ol>
    </section>
              ...
              <?php
                  ...
                  if ($_SESSION["perfil"] != "Preceptor") {
                      ...
                      echo '<div class="box-header with-border">                                      
                        ...
                        <button class="btn btn-primary btnInformePrimero" mat="'.$ma.'" curso="'.$mate['curso_id'].'" periodo="'.$_SESSION['periodo'].'" idCurso=6 tabla="primero" informe="informe-curso-primero">
