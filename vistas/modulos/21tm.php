...
?>       
  ...
  <div class="content-wrapper">
    ...
    <?php
          ...
          2º Primera - Turno Mañana - Materia: '.$mate["materia"].'
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">2º Primera TM</li>
      </ol>
    </section>
              ...
              <?php
                  ...
                  if ($_SESSION["perfil"] != "Preceptor") {
                      ...
                      echo '<div class="box-header with-border">                                      
                        ...
                        <button class="btn btn-primary btnInformeSegundo" mat="'.$ma.'" curso="'.$mate['curso_id'].'" periodo="'.$_SESSION['periodo'].'" idCurso=7 tabla="segundo" informe="informe-curso-segundo">
