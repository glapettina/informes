...
?>       
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        2º Tercera Electromecánica - Turno Vespertino
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">2º Tercera Electromecánica TV</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">                                      
                ...
                <button class="btn btn-primary btnInformeCuarto" modalidad="superiore" materia="'.$_SESSION['materia'].'" ciclo="superiore" curso="cuarto" periodo="'.$_SESSION['periodo'].'" idCurso=19 tabla="cuarto" informe="informe-curso-cuarto">
