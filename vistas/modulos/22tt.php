  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <?php
                  ...
                  2º Segunda - Turno Tarde - Materia: '.$mate["materia"].'
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">2º Segunda TT</li>
      </ol>
    </section>
                ...
                <?php
                  ...
                  if ($_SESSION["perfil"] != "Preceptor") {
                    ...
                    echo '<div class="box-header with-border">                                      
                      ...
                      <button class="btn btn-primary btnInformeSegundo" mat="'.$ma.'" curso="'.$mate['curso_id'].'" periodo="'.$_SESSION['periodo'].'" idCurso=11 tabla="segundo" informe="informe-curso-segundo">
