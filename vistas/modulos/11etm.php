...
?>       
  ...
  <div class="content-wrapper">
    ...
    <?php
              ...
              1º Primera Electromecánica - Turno Mañana - Materia: '.$mate["materia"].'
              ...
              echo '<h1>
              1º Primera Electromecánica - Turno Mañana
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">1º Primera E TM</li>
      </ol>
    </section>
              ...
              <?php
                  ...
                  if ($_SESSION["perfil"] != "Preceptor") {
                      ...
                      echo '<div class="box-header with-border">                                      
                        ...
                        <button class="btn btn-primary btnInformeTercero" mat="'.$ma.'" curso="'.$mate['curso_id'].'" periodo="'.$_SESSION['periodo'].'" idCurso=14 tabla="tercero" modalidad="Electromecánica" informe="informe-curso-tercero">
