  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">4º Primera Electromecánica TV</li>
      </ol>
    </section>
        ...
        <?php
          ...
          if ($_SESSION["perfil"] != "Preceptor") {
              ...
              echo '<div class="box-header with-border">                                      
                ...
                <button class="btn btn-primary btnInformeSexto" modalidad="superiore" materia="'.$_SESSION['materia'].'" ciclo="superiore" curso="sexto" periodo="'.$_SESSION['periodo'].'" idCurso=24 tabla="sexto" informe="informe-curso-sexto">
