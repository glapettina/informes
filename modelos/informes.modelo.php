<?php
	...
	class ModeloInformes{
		...
		static public function mdlEditarInformePrimero($tabla, $curso, $datos, $concepto, $observa, $campo1, $campo2){

			$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET $campo1 = :$concepto, $campo2 = :$observa, id_usuario = :id_usuario WHERE id = :id");

			$stmt->bindParam(":id", $datos["id"], PDO::PARAM_INT);
			$stmt->bindParam(":".$concepto, $datos["nota"], PDO::PARAM_STR);
