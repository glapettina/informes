<?php
	...
	class ControladorInformes{
		...
		static public function ctrEditarInformePrimero($tabla, $curso, $concepto, $observa, $campo1, $campo2){

			if (isset($_POST[$concepto])) {
				
											

					$datos = array("nota" => $_POST[$concepto], "observacion" => $_POST[$observa], "id_usuario" => $_SESSION["id"], "id" => $_POST["idAlumno"]);



					$respuesta = ModeloInformes::mdlEditarInformePrimero($tabla, $curso, $datos, $concepto, $observa, $campo1, $campo2);
